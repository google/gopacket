...
// Generated at 2012-12-04 17:53:57.555655 -0700 MST
...
var validMACPrefixMap map[[3]byte]string = map[[3]byte]string{
	...
	[3]byte{0, 0, 94}:      "USC INFORMATION SCIENCES INST",
	...
	[3]byte{0, 1, 26}:      "EEH DataLink GmbH",
	...
	[3]byte{0, 1, 248}:     "Adherent Systems, Ltd.",
	...
	[3]byte{0, 2, 14}:      "ECI Telecom, Ltd., NSD-US",
	[3]byte{0, 2, 15}:      "AATR",
	...
	[3]byte{0, 2, 249}:     "Mimos Semiconductor SDN BHD",
	...
	[3]byte{0, 3, 16}:      "ITX E-Globaledge Corporation",
	...
	[3]byte{0, 3, 95}:      "Prueftechnik Condition Monitoring GmbH & Co. KG",
	...
	[3]byte{0, 3, 147}:     "Apple Computer, Inc.",
	...
	[3]byte{0, 4, 12}:      "KANNO Work's Ltd.",
	...
	[3]byte{0, 4, 95}:      "Evalue Technology, Inc.",
	...
	[3]byte{0, 4, 100}:     "Fantasma Networks, Inc.",
	...
	[3]byte{0, 4, 189}:     "Motorola Mobility, Inc.",
	...
	[3]byte{0, 4, 205}:     "Informedia Research Group",
	...
	[3]byte{0, 5, 156}:     "Kleinknecht GmbH, Ing. Buero",
	...
	[3]byte{0, 6, 49}:      "Optical Solutions, Inc.",
	...
	[3]byte{0, 6, 60}:      "Intrinsyc Europe Ltd",
	...
	[3]byte{0, 6, 152}:     "egnite Software GmbH",
	...
	[3]byte{0, 6, 166}:     "Artistic Licence (UK) Ltd",
	...
	[3]byte{0, 6, 246}:     "Cisco Systems",
	[3]byte{0, 6, 247}:     "ALPS Electric Co,. Ltd.",
	[3]byte{0, 6, 248}:     "CPU Technology, Inc.",
	...
	[3]byte{0, 7, 27}:      "CDV Americas Ltd",
	...
	[3]byte{0, 7, 49}:      "Ophir-Spiricon Inc",
	...
	[3]byte{0, 7, 112}:     "Locusnetworks Corporation",
	...
	[3]byte{0, 7, 146}:     "Suetron Electronic GmbH",
	...
	[3]byte{0, 7, 210}:     "Logopak Systeme",
	[3]byte{0, 7, 211}:     "Stork Prints B.V.",
	...
	[3]byte{0, 8, 14}:      "Motorola Mobility, Inc.",
	...
	[3]byte{0, 8, 47}:      "Cisco Systems",
	[3]byte{0, 8, 48}:      "Cisco Systems",
	[3]byte{0, 8, 49}:      "Cisco Systems",
	[3]byte{0, 8, 50}:      "Cisco",
	...
	[3]byte{0, 8, 133}:     "EMS Dr. Thomas Wuensche",
	...
	[3]byte{0, 8, 163}:     "Cisco Systems",
	[3]byte{0, 8, 164}:     "Cisco Systems",
	...
	[3]byte{0, 8, 174}:     "PacketFront International AB",
	...
	[3]byte{0, 8, 211}:     "Hercules Technologies S.A.",
	...
	[3]byte{0, 8, 226}:     "Cisco Systems",
	[3]byte{0, 8, 227}:     "Cisco Systems",
	...
	[3]byte{0, 9, 17}:      "Cisco Systems",
	[3]byte{0, 9, 18}:      "Cisco Systems",
	...
	[3]byte{0, 9, 67}:      "Cisco Systems",
	[3]byte{0, 9, 68}:      "Cisco Systems",
	...
	[3]byte{0, 9, 123}:     "Cisco Systems",
	[3]byte{0, 9, 124}:     "Cisco Systems",
	...
	[3]byte{0, 9, 182}:     "Cisco Systems",
	[3]byte{0, 9, 183}:     "Cisco Systems",
	...
	[3]byte{0, 9, 232}:     "Cisco Systems",
	[3]byte{0, 9, 233}:     "Cisco Systems",
	...
	[3]byte{0, 10, 39}:     "Apple Computer, Inc.",
	...
	[3]byte{0, 10, 65}:     "Cisco Systems",
	[3]byte{0, 10, 66}:     "Cisco Systems",
	...
	[3]byte{0, 10, 121}:    "Allied Telesis K.K. corega division",
	...
	[3]byte{0, 10, 138}:    "Cisco Systems",
	[3]byte{0, 10, 139}:    "Cisco Systems",
	...
	[3]byte{0, 10, 149}:    "Apple Computer, Inc.",
	...
	[3]byte{0, 10, 183}:    "Cisco Systems",
	[3]byte{0, 10, 184}:    "Cisco Systems",
	...
	[3]byte{0, 10, 243}:    "Cisco Systems",
	[3]byte{0, 10, 244}:    "Cisco Systems",
	...
	[3]byte{0, 11, 6}:      "Motorola Mobility, Inc.",
	...
	[3]byte{0, 11, 95}:     "Cisco Systems",
	[3]byte{0, 11, 96}:     "Cisco Systems",
	[3]byte{0, 11, 97}:     "Friedrich Lütze GmbH & Co. KG",
	[3]byte{0, 11, 98}:     "Ingenieurbuero fuer Elektronikdesign Ingo Mohnen",
	...
	[3]byte{0, 11, 122}:    "Wave Science Inc.",
	...
	[3]byte{0, 11, 144}:    "Adva Optical Networking Inc.",
	...
	[3]byte{0, 11, 190}:    "Cisco Systems",
	[3]byte{0, 11, 191}:    "Cisco Systems",
	...
	[3]byte{0, 11, 219}:    "Dell ESG PCBA Test",
	...
	[3]byte{0, 11, 229}:    "HIMS Korea Co., Ltd.",
	...
	[3]byte{0, 11, 252}:    "Cisco Systems",
	[3]byte{0, 11, 253}:    "Cisco Systems",
	...
	[3]byte{0, 12, 48}:     "Cisco",
	[3]byte{0, 12, 49}:     "Cisco",
	...
	[3]byte{0, 12, 90}:     "IBSmm Industrieelektronik Multimedia",
	...
	[3]byte{0, 12, 133}:    "Cisco Systems",
	[3]byte{0, 12, 134}:    "Cisco Systems",
	[3]byte{0, 12, 135}:    "AMD",
	...
	[3]byte{0, 12, 157}:    "AirWalk Communications, Inc.",
	...
	[3]byte{0, 12, 206}:    "Cisco Systems",
	[3]byte{0, 12, 207}:    "Cisco Systems",
	...
	[3]byte{0, 12, 229}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 13, 19}:     "Wilhelm Rutenbeck GmbH&Co.",
	...
	[3]byte{0, 13, 40}:     "Cisco",
	[3]byte{0, 13, 41}:     "Cisco",
	...
	[3]byte{0, 13, 101}:    "Cisco Systems",
	[3]byte{0, 13, 102}:    "Cisco Systems",
	[3]byte{0, 13, 103}:    "BelAir Networks Inc.",
	...
	[3]byte{0, 13, 141}:    "ProLinx Communication Gateways, Inc.",
	...
	[3]byte{0, 13, 147}:    "Apple Computer",
	...
	[3]byte{0, 13, 188}:    "Cisco Systems",
	[3]byte{0, 13, 189}:    "Cisco Systems",
	...
	[3]byte{0, 13, 236}:    "Cisco Systems",
	[3]byte{0, 13, 237}:    "Cisco Systems",
	...
	[3]byte{0, 14, 47}:     "Disetronic Medical Systems AG",
	...
	[3]byte{0, 14, 56}:     "Cisco Systems",
	[3]byte{0, 14, 57}:     "Cisco Systems",
	...
	[3]byte{0, 14, 92}:     "Motorola Mobility, Inc.",
	...
	[3]byte{0, 14, 110}:    "MICRELEC  ELECTRONICS S.A",
	...
	[3]byte{0, 14, 131}:    "Cisco Systems",
	[3]byte{0, 14, 132}:    "Cisco Systems",
	...
	[3]byte{0, 14, 146}:    "Millinet Co., Ltd.",
	...
	[3]byte{0, 14, 214}:    "Cisco Systems",
	[3]byte{0, 14, 215}:    "Cisco Systems",
	...
	[3]byte{0, 15, 50}:     "Lootom Optoelectronic Technology (Wuxi) Co Ltd",
	[3]byte{0, 15, 51}:     "DUALi Inc.",
	[3]byte{0, 15, 52}:     "Cisco Systems",
	[3]byte{0, 15, 53}:     "Cisco Systems",
	...
	[3]byte{0, 15, 93}:     "PacketFront International AB",
	[3]byte{0, 15, 94}:     "Veo",
	...
	[3]byte{0, 15, 129}:    "Secure Info Imaging",
	...
	[3]byte{0, 15, 247}:    "Cisco Systems",
	[3]byte{0, 15, 248}:    "Cisco  Systems",
	...
	[3]byte{0, 16, 76}:     "LeCroy Corporation",
	...
	[3]byte{0, 16, 117}:    "Maxtor Corporation",
	...
	[3]byte{0, 16, 218}:    "MOTION ENGINEERING, INC.",
	...
	[3]byte{0, 16, 248}:    "Niikke Techno System Co. Ltd",
	...
	[3]byte{0, 17, 26}:     "Motorola Mobility, Inc.",
	...
	[3]byte{0, 17, 32}:     "Cisco Systems",
	[3]byte{0, 17, 33}:     "Cisco Systems",
	[3]byte{0, 17, 34}:     "CIMSYS Inc",
	[3]byte{0, 17, 35}:     "Appointech, Inc.",
	[3]byte{0, 17, 36}:     "Apple Computer",
	...
	[3]byte{0, 17, 92}:     "Cisco",
	[3]byte{0, 17, 93}:     "Cisco",
	...
	[3]byte{0, 17, 128}:    "Motorola Mobility, Inc.",
	[3]byte{0, 17, 129}:    "InterEnergy Co.Ltd,",
	[3]byte{0, 17, 130}:    "IMI Norgren Ltd",
	[3]byte{0, 17, 131}:    "Datalogic Mobile, Inc.",
	...
	[3]byte{0, 17, 146}:    "Cisco Systems",
	[3]byte{0, 17, 147}:    "Cisco Systems",
	...
	[3]byte{0, 17, 174}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 17, 187}:    "Cisco Systems",
	[3]byte{0, 17, 188}:    "Cisco Systems",
	...
	[3]byte{0, 17, 198}:    "Seagate Technology LLC",
	...
	[3]byte{0, 18, 10}:     "Emerson Electric GmbH & Co. OHG",
	...
	[3]byte{0, 18, 31}:     "Harding Intruments",
	...
	[3]byte{0, 18, 37}:     "Motorola Mobility, Inc.",
	...
	[3]byte{0, 18, 67}:     "Cisco",
	[3]byte{0, 18, 68}:     "Cisco",
	...
	[3]byte{0, 18, 79}:     "Tyco Thermal Controls LLC.",
	...
	[3]byte{0, 18, 103}:    "Matsushita Electronic Components Co., Ltd.",
	...
	[3]byte{0, 18, 127}:    "Cisco",
	[3]byte{0, 18, 128}:    "Cisco",
	...
	[3]byte{0, 18, 138}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 18, 201}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 18, 217}:    "Cisco Systems",
	[3]byte{0, 18, 218}:    "Cisco Systems",
	...
	[3]byte{0, 19, 3}:      "GateConnect Technologies GmbH",
	...
	[3]byte{0, 19, 25}:     "Cisco Systems",
	[3]byte{0, 19, 26}:     "Cisco Systems",
	...
	[3]byte{0, 19, 95}:     "Cisco Systems",
	[3]byte{0, 19, 96}:     "Cisco Systems",
	...
	[3]byte{0, 19, 104}:    "Maersk Data Defence",
	[3]byte{0, 19, 105}:    "Honda Electron Co., LED.",
	[3]byte{0, 19, 106}:    "Hach Lange SA",
	...
	[3]byte{0, 19, 113}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 19, 127}:    "Cisco Systems",
	[3]byte{0, 19, 128}:    "Cisco Systems",
	...
	[3]byte{0, 19, 195}:    "Cisco Systems",
	[3]byte{0, 19, 196}:    "Cisco Systems",
	...
	[3]byte{0, 20, 4}:      "Motorola Mobility, Inc.",
	...
	[3]byte{0, 20, 19}:     "Trebing & Himstedt Prozessautomation GmbH & Co. KG",
	...
	[3]byte{0, 20, 27}:     "Cisco Systems",
	[3]byte{0, 20, 28}:     "Cisco Systems",
	[3]byte{0, 20, 29}:     "Lust Antriebstechnik GmbH",
	...
	[3]byte{0, 20, 68}:     "Grundfos Electronics",
	...
	[3]byte{0, 20, 81}:     "Apple Computer Inc.",
	...
	[3]byte{0, 20, 105}:    "Cisco Systems",
	[3]byte{0, 20, 106}:    "Cisco Systems",
	...
	[3]byte{0, 20, 145}:    "Daniels Electronics Ltd.",
	...
	[3]byte{0, 20, 154}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 20, 168}:    "Cisco Systems",
	[3]byte{0, 20, 169}:    "Cisco Systems",
	...
	[3]byte{0, 20, 195}:    "Seagate Technology LLC",
	...
	[3]byte{0, 20, 232}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 20, 241}:    "Cisco Systems",
	[3]byte{0, 20, 242}:    "Cisco Systems",
	...
	[3]byte{0, 21, 43}:     "Cisco Systems",
	[3]byte{0, 21, 44}:     "Cisco Systems",
	[3]byte{0, 21, 45}:     "TenX Networks, LLC",
	[3]byte{0, 21, 46}:     "PacketHop, Inc.",
	[3]byte{0, 21, 47}:     "Motorola Mobility, Inc.",
	[3]byte{0, 21, 48}:     "Bus-Tech, Inc.",
	...
	[3]byte{0, 21, 98}:     "Cisco Systems",
	[3]byte{0, 21, 99}:     "Cisco Systems",
	...
	[3]byte{0, 21, 118}:    "scil animal care company GmbH",
	...
	[3]byte{0, 21, 136}:    "Balda Solution Malaysia Sdn Bhd",
	...
	[3]byte{0, 21, 154}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 21, 168}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 21, 198}:    "Cisco Systems",
	[3]byte{0, 21, 199}:    "Cisco Systems",
	...
	[3]byte{0, 21, 231}:    "Quantec ProAudio",
	...
	[3]byte{0, 21, 249}:    "Cisco Systems",
	[3]byte{0, 21, 250}:    "Cisco Systems",
	...
	[3]byte{0, 22, 25}:     "La Factoría de Comunicaciones Aplicadas,S.L.",
	...
	[3]byte{0, 22, 38}:     "Motorola Mobility, Inc.",
	...
	[3]byte{0, 22, 70}:     "Cisco Systems",
	[3]byte{0, 22, 71}:     "Cisco Systems",
	...
	[3]byte{0, 22, 111}:    "Intel Corporation",
	...
	[3]byte{0, 22, 117}:    "Motorola Mobility, Inc.",
	[3]byte{0, 22, 118}:    "Intel Corporation",
	...
	[3]byte{0, 22, 156}:    "Cisco Systems",
	[3]byte{0, 22, 157}:    "Cisco Systems",
	...
	[3]byte{0, 22, 171}:    "PBI-Dansensor A/S",
	...
	[3]byte{0, 22, 181}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 22, 199}:    "Cisco Systems",
	[3]byte{0, 22, 200}:    "Cisco Systems",
	[3]byte{0, 22, 201}:    "NAT Seattle, Inc.",
	[3]byte{0, 22, 202}:    "Nortel",
	[3]byte{0, 22, 203}:    "Apple Computer",
	...
	[3]byte{0, 22, 234}:    "Intel Corporation",
	[3]byte{0, 22, 235}:    "Intel Corporation",
	...
	[3]byte{0, 22, 247}:    "L-3 Communications, Electrodynamics, Inc.",
	...
	[3]byte{0, 23, 0}:      "Motorola Mobility, Inc.",
	...
	[3]byte{0, 23, 14}:     "Cisco Systems",
	[3]byte{0, 23, 15}:     "Cisco Systems",
	...
	[3]byte{0, 23, 42}:     "Proware Technology Corp.",
	...
	[3]byte{0, 23, 89}:     "Cisco Systems",
	[3]byte{0, 23, 90}:     "Cisco Systems",
	...
	[3]byte{0, 23, 132}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 23, 148}:    "Cisco Systems",
	[3]byte{0, 23, 149}:    "Cisco Systems",
	...
	[3]byte{0, 23, 200}:    "Kyocera Mita Corporation",
	...
	[3]byte{0, 23, 223}:    "Cisco Systems",
	[3]byte{0, 23, 224}:    "Cisco Systems",
	[3]byte{0, 23, 225}:    "DACOS Technologies Co., Ltd.",
	[3]byte{0, 23, 226}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 23, 238}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 23, 242}:    "Apple Computer",
	...
	[3]byte{0, 24, 24}:     "Cisco Systems",
	[3]byte{0, 24, 25}:     "Cisco Systems",
	...
	[3]byte{0, 24, 115}:    "Cisco Systems",
	[3]byte{0, 24, 116}:    "Cisco Systems",
	...
	[3]byte{0, 24, 164}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 24, 185}:    "Cisco Systems",
	[3]byte{0, 24, 186}:    "Cisco Systems",
	...
	[3]byte{0, 24, 192}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 24, 222}:    "Intel Corporation",
	...
	[3]byte{0, 25, 6}:      "Cisco Systems",
	[3]byte{0, 25, 7}:      "Cisco Systems",
	[3]byte{0, 25, 8}:      "Duaxes Corporation",
	[3]byte{0, 25, 9}:      "Devi A/S",
	...
	[3]byte{0, 25, 44}:     "Motorola Mobility, Inc.",
	[3]byte{0, 25, 45}:     "Nokia Corporation",
	[3]byte{0, 25, 46}:     "Spectral Instruments, Inc.",
	[3]byte{0, 25, 47}:     "Cisco Systems",
	[3]byte{0, 25, 48}:     "Cisco Systems",
	...
	[3]byte{0, 25, 53}:     "Duerr Dental GmbH & Co. KG",
	...
	[3]byte{0, 25, 85}:     "Cisco Systems",
	[3]byte{0, 25, 86}:     "Cisco Systems",
	...
	[3]byte{0, 25, 94}:     "Motorola Mobility, Inc.",
	...
	[3]byte{0, 25, 158}:    "SHOWADENSHI ELECTRONICS,INC.",
	...
	[3]byte{0, 25, 166}:    "Motorola Mobility, Inc.",
	[3]byte{0, 25, 167}:    "ITU-T",
	[3]byte{0, 25, 168}:    "WiQuest Communications",
	[3]byte{0, 25, 169}:    "Cisco Systems",
	[3]byte{0, 25, 170}:    "Cisco Systems",
	...
	[3]byte{0, 25, 192}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 26, 8}:      "Dalman Technical Services",
	...
	[3]byte{0, 26, 27}:     "Motorola Mobility, Inc.",
	...
	[3]byte{0, 26, 41}:     "Techsonic Industries d/b/a Humminbird",
	...
	[3]byte{0, 26, 47}:     "Cisco Systems",
	[3]byte{0, 26, 48}:     "Cisco Systems",
	...
	[3]byte{0, 26, 102}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 26, 108}:    "Cisco Systems",
	[3]byte{0, 26, 109}:    "Cisco Systems",
	...
	[3]byte{0, 26, 119}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 26, 159}:    "A-Link Europe Ltd",
	[3]byte{0, 26, 160}:    "Dell Inc",
	[3]byte{0, 26, 161}:    "Cisco Systems",
	[3]byte{0, 26, 162}:    "Cisco Systems",
	...
	[3]byte{0, 26, 173}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 26, 232}:    "Siemens Enterprise Communications GmbH & Co. KG",
	...
	[3]byte{0, 27, 12}:     "Cisco Systems",
	[3]byte{0, 27, 13}:     "Cisco Systems",
	...
	[3]byte{0, 27, 42}:     "Cisco Systems",
	[3]byte{0, 27, 43}:     "Cisco Systems",
	...
	[3]byte{0, 27, 82}:     "Motorola Mobility, Inc.",
	[3]byte{0, 27, 83}:     "Cisco Systems",
	[3]byte{0, 27, 84}:     "Cisco Systems",
	...
	[3]byte{0, 27, 99}:     "Apple Computer Inc.",
	...
	[3]byte{0, 27, 143}:    "Cisco Systems",
	[3]byte{0, 27, 144}:    "Cisco Systems",
	...
	[3]byte{0, 27, 211}:    "Matsushita Electric Panasonic AVC",
	[3]byte{0, 27, 212}:    "Cisco Systems",
	[3]byte{0, 27, 213}:    "Cisco Systems",
	...
	[3]byte{0, 27, 221}:    "Motorola Mobility, Inc.",
	[3]byte{0, 27, 222}:    "Renkus-Heinz, Inc.",
	[3]byte{0, 27, 223}:    "Iskra MIS",
	...
	[3]byte{0, 28, 14}:     "Cisco Systems",
	[3]byte{0, 28, 15}:     "Cisco Systems",
	[3]byte{0, 28, 16}:     "Cisco-Linksys, LLC",
	[3]byte{0, 28, 17}:     "Motorola Mobility, Inc.",
	[3]byte{0, 28, 18}:     "Motorola Mobility, Inc.",
	...
	[3]byte{0, 28, 46}:     "ProCurve Networking by HP",
	...
	[3]byte{0, 28, 77}:     "Zeemote Technology Inc. (part of Aplix).",
	...
	[3]byte{0, 28, 87}:     "Cisco Systems",
	[3]byte{0, 28, 88}:     "Cisco Systems",
	...
	[3]byte{0, 28, 97}:     "Galaxy Technology (HK) Ltd.",
	[3]byte{0, 28, 98}:     "LG Electronics Inc",
	[3]byte{0, 28, 99}:     "TRUEN",
	[3]byte{0, 28, 100}:    "Cellnet+Hunt",
	...
	[3]byte{0, 28, 176}:    "Cisco Systems",
	[3]byte{0, 28, 177}:    "Cisco Systems",
	...
	[3]byte{0, 28, 193}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 28, 246}:    "Cisco Systems",
	[3]byte{0, 28, 247}:    "AudioScience",
	[3]byte{0, 28, 248}:    "Parade Technologies, Ltd.",
	[3]byte{0, 28, 249}:    "Cisco Systems",
	[3]byte{0, 28, 250}:    "Alarm.com",
	[3]byte{0, 28, 251}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 29, 42}:     "Tideway Electronic LTD",
	...
	[3]byte{0, 29, 64}:     "Living Independently Group, Inc.",
	...
	[3]byte{0, 29, 69}:     "Cisco Systems",
	[3]byte{0, 29, 70}:     "Cisco Systems",
	...
	[3]byte{0, 29, 79}:     "Apple Computer Inc.",
	...
	[3]byte{0, 29, 105}:    "Knorr-Bremse AG",
	[3]byte{0, 29, 106}:    "Alpha Networks Inc.",
	[3]byte{0, 29, 107}:    "Motorola (formerly Netopia, Inc",
	...
	[3]byte{0, 29, 112}:    "Cisco Systems",
	[3]byte{0, 29, 113}:    "Cisco Systems",
	...
	[3]byte{0, 29, 161}:    "Cisco Systems",
	[3]byte{0, 29, 162}:    "Cisco Systems",
	...
	[3]byte{0, 29, 179}:    "ProCurve Networking by HP",
	...
	[3]byte{0, 29, 190}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 29, 200}:    "ScadaMetrcs, LLC.",
	...
	[3]byte{0, 29, 229}:    "Cisco Systems",
	[3]byte{0, 29, 230}:    "Cisco Systems",
	[3]byte{0, 29, 231}:    "Marine Sonic Technology, Ltd.",
	[3]byte{0, 29, 232}:    "Nikko Denki Tsushin Company(NDTC)",
	...
	[3]byte{0, 30, 19}:     "Cisco Systems",
	[3]byte{0, 30, 20}:     "Cisco Systems",
	...
	[3]byte{0, 30, 70}:     "Motorola Mobility, Inc.",
	[3]byte{0, 30, 71}:     "PT. Hariff Daya Tunggal Engineering",
	[3]byte{0, 30, 72}:     "Wi-Links",
	[3]byte{0, 30, 73}:     "Cisco Systems",
	[3]byte{0, 30, 74}:     "Cisco Systems",
	...
	[3]byte{0, 30, 82}:     "Apple Computer Inc",
	...
	[3]byte{0, 30, 90}:     "Motorola Mobility, Inc.",
	...
	[3]byte{0, 30, 107}:    "Scientific Atlanta, A Cisco Company",
	...
	[3]byte{0, 30, 113}:    "Igeacare Solutions Inc.",
	[3]byte{0, 30, 114}:    "PCS",
	...
	[3]byte{0, 30, 121}:    "Cisco Systems",
	[3]byte{0, 30, 122}:    "Cisco Systems",
	...
	[3]byte{0, 30, 141}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 30, 189}:    "Cisco Systems",
	[3]byte{0, 30, 190}:    "Cisco Systems",
	...
	[3]byte{0, 30, 246}:    "Cisco Systems",
	[3]byte{0, 30, 247}:    "Cisco Systems",
	...
	[3]byte{0, 31, 38}:     "Cisco Systems",
	[3]byte{0, 31, 39}:     "Cisco Systems",
	[3]byte{0, 31, 40}:     "ProCurve Networking by HP",
	...
	[3]byte{0, 31, 66}:     "Etherstack Pty Ltd",
	...
	[3]byte{0, 31, 88}:     "EMH Energiemesstechnik GmbH & co.KG",
	...
	[3]byte{0, 31, 108}:    "Cisco Systems",
	[3]byte{0, 31, 109}:    "Cisco Systems",
	...
	[3]byte{0, 31, 126}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 31, 157}:    "Cisco Systems",
	[3]byte{0, 31, 158}:    "Cisco Systems",
	...
	[3]byte{0, 31, 196}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 31, 201}:    "Cisco Systems",
	[3]byte{0, 31, 202}:    "Cisco Systems",
	...
	[3]byte{0, 31, 254}:    "ProCurve Networking by HP",
	...
	[3]byte{0, 32, 64}:     "Motorola Broadband Communications Sector",
	...
	[3]byte{0, 32, 170}:    "DIGIMEDIA VISION LTD.",
	...
	[3]byte{0, 33, 27}:     "Cisco Systems",
	[3]byte{0, 33, 28}:     "Cisco Systems",
	[3]byte{0, 33, 29}:     "Dataline AB",
	[3]byte{0, 33, 30}:     "Motorola Mobility, Inc.",
	...
	[3]byte{0, 33, 54}:     "Motorola Mobility, Inc.",
	...
	[3]byte{0, 33, 85}:     "Cisco Systems",
	[3]byte{0, 33, 86}:     "Cisco Systems",
	...
	[3]byte{0, 33, 128}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 33, 160}:    "Cisco Systems",
	[3]byte{0, 33, 161}:    "Cisco Systems",
	...
	[3]byte{0, 33, 181}:    "Vyro Games Limited",
	...
	[3]byte{0, 33, 193}:    "ABB Oy / Distribution Automation",
	...
	[3]byte{0, 33, 215}:    "Cisco Systems",
	[3]byte{0, 33, 216}:    "Cisco Systems",
	...
	[3]byte{0, 33, 247}:    "ProCurve Networking by HP",
	...
	[3]byte{0, 34, 12}:     "Cisco Systems",
	[3]byte{0, 34, 13}:     "Cisco Systems",
	[3]byte{0, 34, 14}:     "Indigo Security Co., Ltd.",
	[3]byte{0, 34, 15}:     "MoCA (Multimedia over Coax Alliance)",
	[3]byte{0, 34, 16}:     "Motorola Mobility, Inc.",
	...
	[3]byte{0, 34, 85}:     "Cisco Systems",
	[3]byte{0, 34, 86}:     "Cisco Systems",
	...
	[3]byte{0, 34, 129}:    "Daintree Networks Inc",
	[3]byte{0, 34, 130}:    "8086 Limited",
	...
	[3]byte{0, 34, 144}:    "Cisco Systems",
	[3]byte{0, 34, 145}:    "Cisco Systems",
	...
	[3]byte{0, 34, 168}:    "Ouman Finland Oy",
	...
	[3]byte{0, 34, 180}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 34, 189}:    "Cisco Systems",
	[3]byte{0, 34, 190}:    "Cisco Systems",
	...
	[3]byte{0, 34, 200}:    "Applied Instruments",
	...
	[3]byte{0, 35, 4}:      "Cisco Systems",
	[3]byte{0, 35, 5}:      "Cisco Systems",
	...
	[3]byte{0, 35, 11}:     "Motorola Mobility, Inc.",
	...
	[3]byte{0, 35, 51}:     "Cisco Systems",
	[3]byte{0, 35, 52}:     "Cisco Systems",
	...
	[3]byte{0, 35, 65}:     "Siemens AG, Infrastructure & Cities Sector, Building Technologies Division",
	[3]byte{0, 35, 66}:     "Coffee Equipment Company",
	[3]byte{0, 35, 67}:     "TEM AG",
	[3]byte{0, 35, 68}:     "Objective Interface Systems",
	...
	[3]byte{0, 35, 93}:     "Cisco Systems",
	[3]byte{0, 35, 94}:     "Cisco Systems",
	...
	[3]byte{0, 35, 116}:    "Motorola Mobility, Inc.",
	[3]byte{0, 35, 117}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 35, 149}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 35, 154}:    "EasyData Software GmbH",
	...
	[3]byte{0, 35, 162}:    "Motorola Mobility, Inc.",
	[3]byte{0, 35, 163}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 35, 171}:    "Cisco Systems",
	[3]byte{0, 35, 172}:    "Cisco Systems",
	[3]byte{0, 35, 173}:    "Xmark Corporation",
	[3]byte{0, 35, 174}:    "Dell Inc.",
	[3]byte{0, 35, 175}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 35, 234}:    "Cisco Systems",
	[3]byte{0, 35, 235}:    "Cisco Systems",
	[3]byte{0, 35, 236}:    "Algorithmix GmbH",
	[3]byte{0, 35, 237}:    "Motorola CHS",
	[3]byte{0, 35, 238}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 35, 251}:    "IP Datatel, Inc.",
	...
	[3]byte{0, 36, 19}:     "Cisco Systems",
	[3]byte{0, 36, 20}:     "Cisco Systems",
	...
	[3]byte{0, 36, 57}:     "Essential Viewing Systems Limited",
	...
	[3]byte{0, 36, 69}:     "LiquidxStream Systems Inc.",
	...
	[3]byte{0, 36, 80}:     "Cisco Systems",
	[3]byte{0, 36, 81}:     "Cisco Systems",
	...
	[3]byte{0, 36, 147}:    "Motorola, Inc",
	[3]byte{0, 36, 148}:    "Shenzhen Baoxin Tech CO., Ltd.",
	[3]byte{0, 36, 149}:    "Motorola Mobility, Inc.",
	[3]byte{0, 36, 150}:    "Ginzinger electronic systems",
	[3]byte{0, 36, 151}:    "Cisco Systems",
	[3]byte{0, 36, 152}:    "Cisco Systems",
	...
	[3]byte{0, 36, 160}:    "Motorola Mobility, Inc.",
	[3]byte{0, 36, 161}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 36, 193}:    "Motorola Mobility, Inc.",
	[3]byte{0, 36, 194}:    "Asumo Co.,Ltd.",
	[3]byte{0, 36, 195}:    "Cisco Systems",
	[3]byte{0, 36, 196}:    "Cisco Systems",
	...
	[3]byte{0, 36, 247}:    "Cisco Systems",
	[3]byte{0, 36, 248}:    "Technical Solutions Company Ltd.",
	[3]byte{0, 36, 249}:    "Cisco Systems",
	...
	[3]byte{0, 37, 69}:     "Cisco Systems",
	[3]byte{0, 37, 70}:     "Cisco Systems",
	...
	[3]byte{0, 37, 131}:    "Cisco Systems",
	[3]byte{0, 37, 132}:    "Cisco Systems",
	...
	[3]byte{0, 37, 209}:    "Eastech Electronics (Taiwan) Inc.",
	...
	[3]byte{0, 37, 241}:    "Motorola Mobility, Inc.",
	[3]byte{0, 37, 242}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 37, 255}:    "CreNova Technology GmbH",
	...
	[3]byte{0, 38, 10}:     "Cisco Systems",
	[3]byte{0, 38, 11}:     "Cisco Systems",
	[3]byte{0, 38, 12}:     "Dataram",
	[3]byte{0, 38, 13}:     "Micronetics, Inc.",
	...
	[3]byte{0, 38, 54}:     "Motorola Mobility, Inc.",
	...
	[3]byte{0, 38, 60}:     "Bachmann GmbH & Co. KG",
	...
	[3]byte{0, 38, 65}:     "Motorola, Inc",
	[3]byte{0, 38, 66}:     "Motorola, Inc",
	...
	[3]byte{0, 38, 81}:     "Cisco Systems",
	[3]byte{0, 38, 82}:     "Cisco Systems",
	...
	[3]byte{0, 38, 135}:    "ALLIED TELESIS, K.K corega division.",
	...
	[3]byte{0, 38, 152}:    "Cisco Systems",
	[3]byte{0, 38, 153}:    "Cisco Systems",
	...
	[3]byte{0, 38, 186}:    "Motorola Mobility, Inc.",
	...
	[3]byte{0, 38, 202}:    "Cisco Systems",
	[3]byte{0, 38, 203}:    "Cisco Systems",
	...
	[3]byte{0, 38, 215}:    "Xiamen BB Electron & Technology Co., Ltd.",
	...
	[3]byte{0, 38, 221}:    "Fival Corporation",
	...
	[3]byte{0, 39, 12}:     "Cisco Systems",
	[3]byte{0, 39, 13}:     "Cisco Systems",
	...
	[3]byte{0, 48, 98}:     "PATH 1 NETWORK TECHNOL'S INC.",
	[3]byte{0, 48, 99}:     "SANTERA SYSTEMS, INC.",
	[3]byte{0, 48, 100}:    "ADLINK TECHNOLOGY, INC.",
	[3]byte{0, 48, 101}:    "APPLE COMPUTER, INC.",
	[3]byte{0, 48, 102}:    "RFM",
	...
	[3]byte{0, 58, 152}:    "Cisco Systems",
	[3]byte{0, 58, 153}:    "Cisco Systems",
	[3]byte{0, 58, 154}:    "Cisco Systems",
	[3]byte{0, 58, 155}:    "Cisco Systems",
	[3]byte{0, 58, 156}:    "Cisco Systems",
	...
	[3]byte{0, 64, 73}:     "Roche Diagnostics Ltd.",
	...
	[3]byte{0, 64, 102}:    "HITACHI CABLE, LTD.",
	...
	[3]byte{0, 64, 170}:    "VALMET AUTOMATION INC.",
	...
	[3]byte{0, 80, 178}:    "BRODEL AUTOMATION",
	...
	[3]byte{0, 80, 227}:    "Motorola, Inc.",
	[3]byte{0, 80, 228}:    "APPLE COMPUTER, INC.",
	...
	[3]byte{0, 96, 164}:    "GRINAKER SYSTEM TECHNOLOGIES",
	...
	[3]byte{0, 128, 184}:   "BUG, INCORPORATED",
	...
	[3]byte{0, 128, 229}:   "LSI Logic Corporation",
	...
	[3]byte{0, 144, 155}:   "IMAJE",
	[3]byte{0, 144, 156}:   "Motorola, Inc.",
	...
	[3]byte{0, 144, 221}:   "THE MIHARU COMMUNICATIONS CO., LTD.",
	...
	[3]byte{0, 160, 64}:    "APPLE COMPUTER",
	...
	[3]byte{0, 160, 135}:   "Zarlink Semiconductor Ltd.",
	...
	[3]byte{0, 222, 251}:   "Cisco Systems",
	...
	[3]byte{0, 224, 108}:   "AEP Systems International Ltd",
	[3]byte{0, 224, 109}:   "COMPUWARE CORPORATION",
	[3]byte{0, 224, 110}:   "FAR SYSTEMS S.p.A.",
	[3]byte{0, 224, 111}:   "Motorola, Inc.",
	...
	[3]byte{0, 224, 134}:   "CYBEX COMPUTER PRODUCTS",
	[3]byte{0, 224, 135}:   "LeCroy - Networking Productions Division",
	[3]byte{0, 224, 136}:   "LTX CORPORATION",
	...
	[3]byte{0, 224, 205}:   "SENSIS CORPORATION",
	...
	[3]byte{4, 254, 127}:   "Cisco Systems",
	...
	[3]byte{8, 0, 7}:       "APPLE COMPUTER INC.",
	...
	[3]byte{8, 208, 159}:   "Cisco Systems",
	...
	[3]byte{12, 133, 37}:   "Cisco Systems",
	...
	[3]byte{12, 217, 150}:  "Cisco Systems",
	...
	[3]byte{16, 140, 207}:  "Cisco Systems",
	...
	[3]byte{16, 189, 24}:   "Cisco Systems",
	...
	[3]byte{20, 91, 209}:   "Motorola Mobility, Inc.",
	...
	[3]byte{24, 51, 157}:   "Cisco Systems",
	...
	[3]byte{24, 142, 213}:  "Philips Innovative Application NV",
	...
	[3]byte{24, 174, 187}:  "Siemens Programm- und Systementwicklung GmbH&Co.KG",
	...
	[3]byte{24, 239, 99}:   "Cisco Systems",
	...
	[3]byte{28, 20, 72}:    "Motorola Mobility, Inc.",
	[3]byte{28, 23, 211}:   "Cisco Systems",
	[3]byte{28, 24, 74}:    "ShenZhen RicherLink Technologies Co.,LTD",
	[3]byte{28, 25, 222}:   "eyevis GmbH",
	[3]byte{28, 29, 103}:   "Huawei Device Co., Ltd",
	...
	[3]byte{28, 223, 15}:   "Cisco Systems",
	...
	[3]byte{32, 229, 100}:  "Motorola Mobility, Inc.",
	...
	[3]byte{36, 182, 87}:   "Cisco Systems",
	...
	[3]byte{36, 219, 172}:  "Huawei Device Co., Ltd",
	...
	[3]byte{40, 95, 219}:   "Huawei Device Co., Ltd",
	...
	[3]byte{40, 147, 254}:  "Cisco Systems",
	[3]byte{40, 148, 15}:   "Cisco Systems",
	...
	[3]byte{40, 251, 211}:  "Shanghai RagenTek Communication Technology Co.,Ltd.",
	...
	[3]byte{44, 122, 254}:  "IEE&E \"Black\" ops",
	...
	[3]byte{44, 158, 95}:   "Motorola Mobility, Inc.",
	...
	[3]byte{48, 55, 166}:   "Cisco Systems",
	...
	[3]byte{48, 228, 219}:  "Cisco Systems",
	...
	[3]byte{56, 107, 187}:  "Motorola Mobility, Inc.",
	...
	[3]byte{56, 168, 81}:   "Quickset International Inc",
	...
	[3]byte{56, 224, 142}:  "Mitsubishi Electric Co.",
	...
	[3]byte{60, 67, 142}:   "Motorola Mobility, Inc.",
	...
	[3]byte{60, 117, 74}:   "Motorola Mobility, Inc.",
	...
	[3]byte{60, 206, 115}:  "Cisco Systems",
	...
	[3]byte{60, 223, 30}:   "Cisco Systems",
	...
	[3]byte{64, 159, 199}:  "BAEKCHUN ENC Co., Ltd.",
	...
	[3]byte{64, 183, 243}:  "Motorola Mobility, Inc.",
	...
	[3]byte{64, 244, 236}:  "Cisco Systems",
	[3]byte{64, 245, 46}:   "Leica Microsystems (Schweiz) AG",
	[3]byte{64, 252, 137}:  "Motorola Mobility, Inc.",
	...
	[3]byte{68, 133, 0}:    "Intel Corporation",
	...
	[3]byte{68, 211, 202}:  "Cisco Systems",
	...
	[3]byte{68, 228, 217}:  "Cisco Systems",
	...
	[3]byte{80, 61, 229}:   "Cisco Systems",
	...
	[3]byte{80, 87, 168}:   "Cisco Systems",
	...
	[3]byte{84, 165, 27}:   "Huawei Device Co., Ltd",
	...
	[3]byte{88, 53, 217}:   "Cisco Systems",
	...
	[3]byte{88, 188, 39}:   "Cisco Systems",
	[3]byte{88, 189, 163}:  "Nintendo Co., Ltd.",
	[3]byte{88, 191, 234}:  "Cisco Systems",
	...
	[3]byte{92, 76, 169}:   "Huawei Device Co., Ltd",
	[3]byte{92, 80, 21}:    "Cisco Systems",
	...
	[3]byte{96, 17, 153}:   "Data-Tester Inc.",
	...
	[3]byte{100, 0, 241}:   "Cisco Systems",
	...
	[3]byte{100, 22, 141}:  "Cisco Systems",
	...
	[3]byte{100, 128, 153}: "Intel Corporation",
	...
	[3]byte{100, 158, 243}: "Cisco Systems",
	[3]byte{100, 159, 247}: "Kone OYj",
	[3]byte{100, 160, 231}: "Cisco Systems",
	...
	[3]byte{100, 174, 12}:  "Cisco Systems",
	...
	[3]byte{100, 216, 20}:  "Cisco Systems",
	[3]byte{100, 217, 18}:  "Solidica, Inc.",
	[3]byte{100, 217, 137}: "Cisco Systems",
	...
	[3]byte{100, 237, 87}:  "Motorola Mobility, Inc.",
	...
	[3]byte{104, 5, 202}:   "Intel Corporation",
	...
	[3]byte{104, 188, 12}:  "Cisco Systems",
	[3]byte{104, 189, 171}: "Cisco Systems",
	...
	[3]byte{104, 239, 189}: "Cisco Systems",
	...
	[3]byte{108, 80, 77}:   "Cisco Systems",
	...
	[3]byte{108, 156, 237}: "Cisco Systems",
	...
	[3]byte{108, 193, 210}: "Motorola Mobility, Inc.",
	...
	[3]byte{112, 126, 67}:  "Motorola Mobility, Inc.",
	[3]byte{112, 126, 222}: "NASTEC LTD.",
	[3]byte{112, 129, 5}:   "Cisco Systems",
	...
	[3]byte{112, 202, 155}: "Cisco Systems",
	...
	[3]byte{116, 148, 61}:  "Hemisphere GPS",
	...
	[3]byte{116, 231, 198}: "Motorola Mobility, Inc.",
	...
	[3]byte{116, 246, 18}:  "Motorola Mobility, Inc.",
	...
	[3]byte{120, 140, 84}:  "Enkom Technologies Ltd.",
	...
	[3]byte{124, 8, 217}:   "Shanghai Engineering Research Center for Broadband Technologies and Applications",
	[3]byte{124, 9, 43}:    "Bekey A/S",
	[3]byte{124, 10, 80}:   "J-MEX Inc.",
	[3]byte{124, 17, 190}:  "Apple, Inc.",
	[3]byte{124, 20, 118}:  "Damall Technologies S.A.S. Di Ludovic Anselme Glaglanon & C.",
	...
	[3]byte{124, 191, 177}: "Motorola Mobility, Inc.",
	...
	[3]byte{124, 203, 13}:  "Aaxeon Technologies Inc.",
	...
	[3]byte{128, 150, 177}: "Motorola Mobility",
	...
	[3]byte{132, 168, 228}: "Huawei Device Co., Ltd",
	...
	[3]byte{132, 211, 42}:  "IEEE P1905.1",
	...
	[3]byte{136, 67, 225}:  "Cisco Systems",
	...
	[3]byte{136, 240, 119}: "Cisco Systems",
	...
	[3]byte{140, 96, 79}:   "Cisco Systems",
	...
	[3]byte{144, 177, 52}:  "Motorola Mobility, Inc.",
	...
	[3]byte{148, 17, 218}:  "ITF Froschl GmbH",
	...
	[3]byte{148, 204, 185}: "Motorola Mobility, Inc.",
	...
	[3]byte{152, 75, 74}:   "Motorola Mobility Inc.",
	...
	[3]byte{152, 142, 221}: "Raychem International",
	...
	[3]byte{156, 78, 32}:   "Cisco Systems",
	...
	[3]byte{156, 175, 202}: "Cisco Systems",
	...
	[3]byte{160, 54, 159}:  "Intel Corporation",
	...
	[3]byte{160, 207, 91}:  "Cisco Systems",
	...
	[3]byte{164, 76, 17}:   "Cisco Systems",
	...
	[3]byte{164, 86, 48}:   "Cisco Systems",
	...
	[3]byte{164, 237, 78}:  "Motorola Mobility, Inc.",
	...
	[3]byte{168, 177, 212}: "Cisco Systems",
	...
	[3]byte{172, 131, 240}: "Magenta Video Networks",
	...
	[3]byte{172, 160, 22}:  "Cisco Systems",
	...
	[3]byte{176, 119, 172}: "Motorola Mobility, Inc.",
	...
	[3]byte{180, 20, 137}:  "Cisco Systems",
	...
	[3]byte{180, 164, 227}: "Cisco Systems",
	...
	[3]byte{180, 224, 205}: "IO Turbine, Inc.",
	...
	[3]byte{184, 98, 31}:   "Cisco Systems",
	...
	[3]byte{184, 190, 191}: "Cisco Systems",
	...
	[3]byte{184, 202, 58}:  "Dell PCBA Test",
	...
	[3]byte{188, 118, 112}: "Huawei Device Co., Ltd",
	...
	[3]byte{192, 39, 185}:  "Beijing National Railway Research & Design Institute  of Signal & Communication",
	...
	[3]byte{192, 98, 107}:  "Cisco Systems",
	...
	[3]byte{192, 163, 100}: "3D Systems Burlington",
	...
	[3]byte{192, 186, 230}: "Application Solutions (Safety and Security) Ltd",
	...
	[3]byte{196, 10, 203}:  "Cisco Systems",
	...
	[3]byte{196, 74, 208}:  "FIREFLIES RTLS",
	...
	[3]byte{196, 113, 254}: "Cisco Systems",
	...
	[3]byte{196, 125, 79}:  "Cisco Systems",
	[3]byte{196, 130, 63}:  "Fujian Newland Auto-ID Tech. Co,.Ltd.",
	[3]byte{196, 133, 8}:   "Intel Corporation",
	...
	[3]byte{200, 76, 117}:  "Cisco Systems",
	...
	[3]byte{200, 156, 29}:  "Cisco Systems",
	...
	[3]byte{200, 170, 33}:  "Motorola Mobility, Inc.",
	...
	[3]byte{204, 125, 55}:  "Motorola Mobility, Inc.",
	...
	[3]byte{204, 150, 160}: "Huawei Device Co., Ltd",
	...
	[3]byte{204, 239, 72}:  "Cisco Systems",
	...
	[3]byte{208, 87, 76}:   "Cisco Systems",
	...
	[3]byte{208, 194, 130}: "Cisco Systems",
	[3]byte{208, 205, 225}: "Scientech Electronics",
	[3]byte{208, 207, 94}:  "Energy Micro AS",
	[3]byte{208, 208, 253}: "Cisco Systems",
	[3]byte{208, 210, 18}:  "K2NET Co.,Ltd.",
	[3]byte{208, 210, 134}: "Beckman Coulter Biomedical K.K.",
	...
	[3]byte{212, 123, 117}: "HARTING Electronics GmbH & Co. KG",
	...
	[3]byte{212, 140, 181}: "Cisco Systems",
	...
	[3]byte{212, 160, 42}:  "Cisco Systems",
	...
	[3]byte{212, 215, 72}:  "Cisco Systems",
	...
	[3]byte{216, 36, 189}:  "Cisco Systems",
	...
	[3]byte{216, 66, 172}:  "FreeComm Data Communication Co.,Ltd.",
	...
	[3]byte{216, 103, 217}: "Cisco Systems",
	...
	[3]byte{220, 11, 26}:   "ADB Broadband SpA",
	...
	[3]byte{220, 123, 148}: "Cisco Systems",
	...
	[3]byte{224, 95, 185}:  "Cisco Systems",
	...
	[3]byte{228, 100, 73}:  "Motorola Mobility, Inc.",
	...
	[3]byte{228, 131, 153}: "Motorola Mobility, Inc.",
	...
	[3]byte{232, 64, 64}:   "Cisco Systems",
	...
	[3]byte{232, 109, 82}:  "Motorola Mobility, Inc.",
	...
	[3]byte{232, 183, 72}:  "Cisco Systems",
	[3]byte{232, 186, 112}: "Cisco Systems",
	...
	[3]byte{236, 48, 145}:  "Cisco Systems",
	...
	[3]byte{236, 68, 118}:  "Cisco Systems",
	...
	[3]byte{236, 200, 130}: "Cisco Systems",
	...
	[3]byte{240, 37, 114}:  "Cisco Systems",
	...
	[3]byte{240, 229, 195}: "Draegerwerk AG &amp;amp; Co. KG aA",
	...
	[3]byte{240, 247, 85}:  "Cisco Systems",
	...
	[3]byte{244, 127, 53}:  "Cisco Systems",
	...
	[3]byte{244, 172, 193}: "Cisco Systems",
	...
	[3]byte{244, 199, 20}:  "Huawei Device Co., Ltd",
	...
	[3]byte{244, 234, 103}: "Cisco Systems",
	...
	[3]byte{248, 11, 190}:  "Motorola Mobility, Inc.",
	...
	[3]byte{248, 102, 242}: "Cisco Systems",
	...
	[3]byte{248, 123, 122}: "Motorola Mobility, Inc.",
	...
	[3]byte{248, 231, 181}: "µTech Engenharia e Automação LTDA",
	...
	[3]byte{252, 42, 84}:   "connected data",
	...
	[3]byte{252, 251, 251}: "Cisco Systems",
}
