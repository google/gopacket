...
var emptyCaptureInfo gopacket.CaptureInfo
...
func (h *EthernetHandle) readOne() (ci gopacket.CaptureInfo, vlan int, haveVlan bool, err error) {
	...
	case e.Temporary() || e.Timeout():
		return emptyCaptureInfo, 0, false, e
	case e != 0:
		return emptyCaptureInfo, 0, false, fmt.Errorf("couldn't read packet: %w", e)
	}
...
func (h *EthernetHandle) ReadPacketData() ([]byte, gopacket.CaptureInfo, error) {
	...
	if err != nil {
		h.mu.Unlock()
		return nil, emptyCaptureInfo, err
	}
