...
func TestPacketPrism(t *testing.T) {
	...
	if got, ok := p.Layer(LayerTypePrismHeader).(*PrismHeader); ok {
		want := &PrismHeader{
			...
			Values: []PrismValue{
				PrismValue{DID: 0x10044, Status: 0x0, Length: 0x4, Data: []uint8{0xf9, 0xc1, 0x29, 0x0}},
				PrismValue{DID: 0x20044, Status: 0x0, Length: 0x0, Data: []uint8{}},
				PrismValue{DID: 0x30044, Status: 0x0, Length: 0x4, Data: []uint8{0xa, 0x0, 0x0, 0x0}},
				PrismValue{DID: 0x40044, Status: 0x0, Length: 0x4, Data: []uint8{0xe1, 0xff, 0xff, 0xff}},
				PrismValue{DID: 0x0, Status: 0x0, Length: 0x0, Data: []uint8{}},
				PrismValue{DID: 0x60044, Status: 0x0, Length: 0x4, Data: []uint8{0x0, 0x0, 0x0, 0x0}},
				PrismValue{DID: 0x70044, Status: 0x0, Length: 0x4, Data: []uint8{0x0, 0x0, 0x0, 0x0}},
				PrismValue{DID: 0x80044, Status: 0x0, Length: 0x4, Data: []uint8{0x2, 0x0, 0x0, 0x0}},
				PrismValue{DID: 0x90044, Status: 0x0, Length: 0x0, Data: []uint8{}},
				PrismValue{DID: 0xa0044, Status: 0x0, Length: 0x4, Data: []uint8{0x7e, 0x0, 0x0, 0x0}},
			},
		}
