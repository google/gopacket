...
var (
	...
	LayerTypeDot11ControlAck                = gopacket.RegisterLayerType(88, gopacket.LayerTypeMetadata{"Dot11ControlAck", gopacket.DecodeFunc(decodeDot11ControlAck)})
	LayerTypeDot11ControlCFPeriodEnd        = gopacket.RegisterLayerType(89, gopacket.LayerTypeMetadata{"Dot11ControlCFPeriodEnd", gopacket.DecodeFunc(decodeDot11ControlCFPeriodEnd)})
	LayerTypeDot11ControlCFPeriodEndAck     = gopacket.RegisterLayerType(90, gopacket.LayerTypeMetadata{"Dot11ControlCFPeriodEndAck", gopacket.DecodeFunc(decodeDot11ControlCFPeriodEndAck)})
