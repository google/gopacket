...
var (
	...
	LayerTypeCDP                  = gopacket.RegisterLayerType(11, gopacket.LayerTypeMetadata{"CDP", gopacket.DecodeFunc(decodeCDP)})
	LayerTypeCTP                  = gopacket.RegisterLayerType(12, gopacket.LayerTypeMetadata{"CTP", gopacket.DecodeFunc(decodeCTP)})
	LayerTypeCTPForwardData       = gopacket.RegisterLayerType(13, gopacket.LayerTypeMetadata{"CTPForwardData", nil})
	LayerTypeCTPReply             = gopacket.RegisterLayerType(14, gopacket.LayerTypeMetadata{"CTPReply", nil})
