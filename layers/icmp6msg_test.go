...
// testPacketICMPv6PacketTooBig is the packet:
// 13:29:25.000001 IP6 fe80::901a:76ff:fe70:48ba > fe80::5e5b:35ff:fe50:285: ICMP6, packet too big, mtu 1500, length 80
//         0x0000:  5c5b 3550 0285 921a 7670 48ba 86dd 6000
//         0x0010:  0000 0050 3a40 fe80 0000 0000 0000 901a
//         0x0020:  76ff fe70 48ba fe80 0000 0000 0000 5e5b
//         0x0030:  35ff fe50 0285 0200 7c5c 0000 05dc 6000
//         0x0040:  0000 0020 3aff fe80 0000 0000 0000 5e5b
//         0x0050:  35ff fe50 0285 fe80 0000 0000 0000 901a
//         0x0060:  76ff fe70 48ba 8700 b635 0000 0000 fe80
//         0x0070:  0000 0000 0000 901a 76ff fe70 48ba 0101
//         0x0080:  5c5b 3550 0285
// the inner packet (the one which is supposedly too big, even though it isn't really --- this is just a test) is:
// 13:38:31.000000 IP6 fe80::5e5b:35ff:fe50:285 > fe80::901a:76ff:fe70:48ba: ICMP6, neighbor solicitation, who has fe80::901a:76ff:fe70:48ba, length 32
var testPacketICMPv6PacketTooBig = []byte{
	,
}

func TestPacketICMPv6PacketTooBig(t *testing.T) {
	p := gopacket.NewPacket(testPacketICMPv6PacketTooBig, LinkTypeEthernet, gopacket.Default)
	if p.ErrorLayer() != nil {
		t.Error("Failed to decode packet:", p.ErrorLayer().Error())
	}
	checkLayers(p, []gopacket.LayerType{LayerTypeEthernet, LayerTypeIPv6, LayerTypeICMPv6, LayerTypeICMPv6PacketTooBig, LayerTypeIPv6, LayerTypeICMPv6, LayerTypeICMPv6NeighborSolicitation}, t)
	ptb, ok := p.Layer(LayerTypeICMPv6PacketTooBig).(*ICMPv6PacketTooBig)
	if !ok || ptb.MTU != 1500 {
		t.Error("Failed to decode requested MTU")
	}
}
