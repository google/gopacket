...
func init() {
	...
	// UsbTypeMetadata[USBTransportTypeIsochronous] = EnumMetadata{DecodeWith: gopacket.DecodeFunc(decodeUsbIsochronous), Name: "Isochronous", LayerType: LayerTypeUsbIsochronous}
