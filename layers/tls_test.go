...
var testClientHello = []byte{
	...
	0xff, 0xff, 0x7c, 0xaf, 0x00, 0x00,
	// TLS Record header (type: handshake (0x16), version: TLS 1.0 (0x0301), length: 209)
	0x16, 0x03, 0x01, 0x00, 0xd1,
	// Record layer (type: ClientHello (0x01), length: 205)
	0x01, 0x00, 0x00, 0xcd,
	0x03,
	...
	Handshake: []TLSHandshakeRecord{
		{
			...
			HandshakeType: handshakeTypePtr(TLSHandshakeClientHello),
			Record:        testClientHello[59:],
		},
	},
	AppData: nil,
	Alert:   nil,
...
var testClientKeyExchange = []byte{
	// TLS Record header (type: handshake (0x16), version: TLS 1.0 (0x0301), length: 70)
	0x16, 0x03, 0x01, 0x00, 0x46,
	// Record layer (type: ClientKeyExchange (0x10), length: 66)
	0x10, 0x00, 0x00, 0x42, 0x00, 0x40, 0x9e, 0x73, 0xdf, 0xe0, 0xf2,
	...
	0x75, 0xe7, 0xb7, 0xa3, 0xce, 0xdb, 0x67, 0x6b, 0x7d, 0x30, 0x2a,
	// TLS record (type: change ciper spec (0x14), version TLS 1.0 (0x0301), length 1)
	0x14, 0x03, 0x01, 0x00, 0x01,
	0x01,
	// TLS Record header (type: handshake (0x16), version: TLS 1.0 (0x0301), length: 48)
	0x16, 0x03, 0x01, 0x00, 0x30,
	// Record layer (Encrypted Handshake)
	0x15, 0xcb, 0x7a, 0x5b, 0x2d, 0xc0, 0x27, 0x09, 0x28, 0x62,
	...
	Handshake: []TLSHandshakeRecord{
		{
			...
			HandshakeType: handshakeTypePtr(TLSHandshakeClientKeyExchange),
			Record:        testClientKeyExchange[5:75],
		},
		{
			TLSRecordHeader: TLSRecordHeader{
				ContentType: 22,
			...
			HandshakeType: nil, // message is encrypted and cannot get handshake type
			Record:        testClientKeyExchange[86:],
		},
	},
	AppData: nil,
	Alert:   nil,
...
func handshakeTypePtr(t TLSHandshakeType) *TLSHandshakeType {
	return &t
}
...
func TestTLSClientKeyExchangeDecodeFromBytes(t *testing.T) {
	var got TLS
